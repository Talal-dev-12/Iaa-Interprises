              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <Link to="/contact">
                      <button className="btn-quote inline-flex items-center gap-1.5 text-sm font-semibold text-accent hover:text-accent/80 bg-accent/8 hover:bg-accent/15 px-4 py-2 rounded-lg transition-colors">
