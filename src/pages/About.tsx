...
import { Target, Eye, Shield, Users, Award, Building2 } from "lucide-react";
  ...
  <main className="pt-20">
    ...
    <section className="py-16 gradient-hero text-center">
      <div className="container mx-auto px-4">
        ...
        <Link to="/contact"><Button variant="hero" size="lg" className="gap-2">Contact Us <ArrowRight className="w-5 h-5" /></Button></Link>
      </div>
    </section>
  </main>
);
